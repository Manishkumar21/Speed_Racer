...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"fly",prev:"prev",next:"next",duration:20*100,delay:20*100,width:1366,height:500,autoPlay:true,stopOnHover:true,loop:false,bullets:true,caption:false,captionEffect:"slide",controls:true,logo:"engine1/loading.gif",onBeforeStep:0,images:0});